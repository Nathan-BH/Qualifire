...
Only needed once per new idea (run from `marketing/silent-studio/`, not inside an existing
composition folder):
...
```powershell
cd "C:\Users\natha\Claude personal projects\Qualifire\marketing\silent-studio\<folder-name>"
