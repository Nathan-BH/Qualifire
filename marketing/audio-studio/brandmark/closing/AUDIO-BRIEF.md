...
|---|---|---|---|---|
| 0 | 0.0–0.5 | Mark fades/scales up | Brand-stinger beat 1: low sub_hit boom at 0.0s | |
| 1 | 0.10–0.60 | "QUALIFIRE" wordmark fades in, overlapping the mark | Stinger beat 1 still ringing | |
| 2 | 0.25–0.75 | Tagline "Same road. New meaning." fades in, overlapping both — everything on screen by 0.75s | Brand-stinger beat 2: bright ring chime at 0.35s + sustained pad (C3/G3/C4) begins | |
| 3 | 0.75–3.5 | Hold on mark + wordmark + tagline | Sustained pad rings through the hold | |
| 4 | 3.5–4.0 | Fade to black | Pad fades naturally into the black | |
