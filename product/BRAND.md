...
`brand/board/board_12_motion.png`): **app launch** — ring draws clockwise from the start
...
`brand/board/brandboard.png` (+ `board/board_01..12`, regenerated by `brand/make_brandboard.py`):
