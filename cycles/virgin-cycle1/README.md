...
## Status at a glance (2026-09-04 — A/B/C/D/F/J/L/N/O/P/Q landed; E/G/K/M ready to execute since 2026-09-03; H and I fully ready to execute as of 2026-09-04, both flagged questions answered)
...
| H | Ride detail screen (RIDES tap + post-stop destination) | **Fully ready to execute (2026-09-04).** Q4 (drop RESULTS) and the nav-model call were resolved 2026-09-03; Nathan answered the one remaining open question 2026-09-04 — "set as reference" now also lets a later ride replace an *existing* route's reference (§3.3b/§4.9b): a reset design (re-seed gates from the new line, clear the route's past results, immediately re-derive so nothing silently reappears re-timed at next boot), behind a one-step warning dialog quoting Nathan's own wording. No blocking questions left; §8.8 notes one non-blocking taste call (reset vs. re-time old rides on the route). | `WP-H-ride-detail-screen.md` |
| I | Gate card on the map + finger scrub | **Fully ready to execute (2026-09-04).** Map half (real ride-line rendering) was ready since 2026-09-03. Nathan answered Q2 2026-09-04: no finger-scrub — §3.5 stays designed-but-unbuilt, `STATE.md`'s tap-then-nudge rule is untouched; instead the existing ±10/±50 m pad becomes a ±0.1%/±1%-of-route-length pad (§3.3b), same four buttons. No blocking questions left. | `WP-I-gate-card-map-scrub.md` |
