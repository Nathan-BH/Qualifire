...
- **Known stubs/flags:** real tower population UNBUILT (B-28); comparison-window persistence landed cycle 015 (B-40, uncommitted — see Awaiting item 0); route identity hardcoded — `FALLBACK_ROUTE`, literal IDs, `results.seed.json` (B-39); the start pick is cosmetic; stationary clock-dim UNBUILT.
